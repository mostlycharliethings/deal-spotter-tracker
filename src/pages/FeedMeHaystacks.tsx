...
import { Search, List, Settings, ArrowLeft, Mail, FileText, Database, TestTube } from 'lucide-react';
      ...
      <div className="min-h-screen p-4" style={{ backgroundColor: 'rgb(251, 250, 247)' }}>
        <div className="max-w-7xl mx-auto space-y-6">
          <div className="text-center space-y-2">
            <img src="/lovable-uploads/ea41d53e-acc5-4adc-83d1-f0ba86082bee.png" alt="Feed Me Haystacks" className="h-64 max-w-full mx-auto object-contain" />
